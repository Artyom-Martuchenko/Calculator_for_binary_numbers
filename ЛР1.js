...
switch (action) {
    ...
    case 2:
        ...
        break;
    case 3:
        alert(`Amount of |${value1}| and |${value2}|: ${toStr(convertToCodeWithFloatingPoint(AdditionOfNumbersWithFloatingPoint(argument)))} or ${parseInt(toStr(AdditionOfNumbersWithFloatingPoint(argument)),2)}`)
        break;
    case 4:
